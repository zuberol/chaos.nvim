...
syn keyword chaos.type.data  inf i res rs log feedback proposal sn def hint code eg ie cite reason hmm conclusion problem desc cm data story glossary roadmap ms usage more goal req about requires scenario cheatsheet tldr summary feat want figure fig nextgroup=@chaos.type.after
